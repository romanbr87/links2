...
export default function UI(props) {
  ...
  return ([
    <div className="container text-center pull-center">
      ...
      <footer className="well well-sm panel-footer text-right" style={{ margin: "0", borderRadius: '0'}}>
      
      <div class="fb-like" data-href="https://links2.vercel.app/" data-width="" data-layout="button_count" data-action="like" data-size="small" data-share="true">
      </div>
